    ...
    <footer className="footer">
      ...
      <div className="footercontent">
        ...
        <div className="icons">
          ...
          <a href="https://www.instagram.com/ieee_rec_studentbranch/" target="_blank" rel="noopener noreferrer">
            <div className="p-2 bg-gray-800 rounded-full hover:bg-gray-700 transition">
              <svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" viewBox="0 0 24 24" fill="white">
          ...
          <a href="https://www.linkedin.com/company/ieee-student-branch-rec/" target="_blank" rel="noopener noreferrer">
            <div className="p-2 bg-gray-800 rounded-full hover:bg-gray-700 transition">
              <svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" viewBox="0 0 24 24" fill="white">
